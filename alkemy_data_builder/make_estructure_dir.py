...
def make_estructure_dir(url_base: Optional[str]) -> Path:
    ...
    if not file_control.exists():
        ...
        # para el logging
        logger.info(
            "Se genero la estructura de directorios para almacenar los archivos CSV y el resultado de los reportes"
        )
    else:
        ...
        # para el logging
        logger.warning(
            "Se quiso volver a generar la estructura de directorios y ya estaba creada creada el "
            + date_create
        )
